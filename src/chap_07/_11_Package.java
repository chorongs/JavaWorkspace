...
public class _11_Package {
    public static void main(String[] args) {
        ...
        System.out.println("랜덤 정수 (범위) : " + random.nextInt(10)); // 0 ~ 10 미만의 정수형
        System.out.println("랜덤 실수 : " + random.nextDouble()); // 0.0 이상 1.0 미만의 실수값
//        System.out.println("랜덤 실수 (범위) : " + random.nextDouble(10.0)); // 사용불가
        ...
        // nextInt(45) : 1 이상 46 미만의 수 = 1 이상 45 이하의 수
